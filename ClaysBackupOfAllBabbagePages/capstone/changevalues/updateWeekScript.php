...
// Close request to clear up some resources
	curl_close($curl);
$result = pg_prepare($connection, "clearweekdata", 'update weekplayerdata set "CurrentAuctionValue" = s."CurrentAuctionValue", "Passyds" = 0, "Rushyds"=0, "Rcvyds"=0, "Fumbles"=0, "TDPass"=0, "TwoPointPass" = 0, "TwoPointRush" = 0, "TDRush"= 0, "TDRcv" = 0, "TwoPointRcv"=0, "ExtraPoint" = 0, "FieldGoal"=0, "FantasyPoints"=0 from seasonplayerdata s where s."NFLPlayerID" = weekplayerdata."NFLPlayerID";');
