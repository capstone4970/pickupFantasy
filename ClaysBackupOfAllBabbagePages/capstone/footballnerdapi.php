/**s page will create the FFN object and then show you how to call the different methods 
...
define('API_KEY', '2013092510267366'); //-- Insert your API key 
define('PHP_SELF', htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'));

require_once("/students/3/cssgf3/public_html/capstone/FFN.class.php");
