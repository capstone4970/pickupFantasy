...
class RostersControllerTest < ActionController::TestCase
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post :create, roster: { flex: @roster.flex, k: @roster.k, leagueID: @roster.leagueID, qb: @roster.qb, rb: @roster.rb, rosterID: @roster.rosterID, username: @roster.username, wr: @roster.wr }
    end
  ...
  test "should update roster" do
    patch :update, id: @roster, roster: { flex: @roster.flex, k: @roster.k, leagueID: @roster.leagueID, qb: @roster.qb, rb: @roster.rb, rosterID: @roster.rosterID, username: @roster.username, wr: @roster.wr }
    assert_redirected_to roster_path(assigns(:roster))
  end
